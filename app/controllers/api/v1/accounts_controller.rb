class Api::V1::AccountsController < Api::BaseController
  ...
  def update
    @account.assign_attributes(account_params.slice(:name, :locale, :domain, :support_email, :theme_color))
  ...
  def account_params
    params.permit(:account_name, :email, :name, :password, :locale, :domain, :support_email, :user_full_name, :theme_color)
  end
